...
SET
  ...
  "retailPrice" = GREATEST(15, ROUND((
    (CASE
      ...
      -- Высокая ниша
      WHEN b.name = ANY(ARRAY['Creed','Maison Francis Kurkdjian','Parfums de Marly','Initio','Initio Parfums Prives','Frederic Malle','Editions de Parfums Frédéric Malle','Le Labo','Byredo','By Kilian','Kilian','Marc-Antoine Barrois','Ex Nihilo','BDK Parfums','Maison Crivelli','Tiziana Terenzi','Bond No. 9','Bond No 9','Sospiro','Memo Paris','Mancera','Montale','Nishane','Parfum d''Empire','Vilhelm Parfumerie','Amouage','Louis Vuitton','Ormonde Jayne','Bortnikoff','Chanel Les Exclusifs','Dior Privée','Armani Privé','Armani/Privé']) THEN 250
      -- Средняя ниша / премиум-эксклюзивы
      WHEN b.name = ANY(ARRAY['Tom Ford','Serge Lutens','Diptyque','Guerlain','Hermès','Hermes','Maison Margiela','Penhaligon''s','Penhaligons','Jo Malone','Jo Malone London','Acqua di Parma','Aedes de Venustas','Etat Libre d''Orange','Juliette Has A Gun','Zoologist','Imaginary Authors','Nasomatto','Orto Parisi','Van Cleef & Arpels','DS & Durga','D.S. & Durga','Bottega Veneta','Goldfield & Banks','Hiram Green','Amouage Library Collection','Boucheron','Chopard']) THEN 165
